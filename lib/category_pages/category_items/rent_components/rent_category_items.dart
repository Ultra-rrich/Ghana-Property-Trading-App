...
import 'package:gpt_app/category_pages/category_items/rent_components/rent_data.dart';
...
class RentHouses extends StatefulWidget {
  const RentHouses({Key? key}) : super(key: key);
...
class _RentHousesState extends State<RentHouses> {
  Widget _buildContext(BuildContext context, int index) {
    House rentHouse = rentHouseList[index];
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => DetailsScreen(house: rentHouse),
          ),
        );
      },
      child: Padding(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      onPressed: () {
                        setState(() {
                          rentHouse.isFav = !rentHouse.isFav;
                          // return;
                        });
                      },
                      icon: rentHouse.isFav
                          ? const Icon(
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            'Ghc${rentHouse.price.toStringAsFixed(2)}/mo',
                            style: const TextStyle(
                              fontSize: 18,
                              color: white,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      child: ListView.builder(
        ...
        itemCount: rentHouseList.length,
