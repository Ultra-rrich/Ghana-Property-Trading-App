...
class BuyHouses extends StatefulWidget {
  const BuyHouses({Key? key}) : super(key: key);

  @override
  State<BuyHouses> createState() => _BuyHousesState();
}
...
class _BuyHousesState extends State<BuyHouses> {
  Widget _buildContext(BuildContext context, int index) {
    House buyHouse = buyHouseList[index];
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => DetailsScreen(house: buyHouse),
          ),
        );
      },
      child: Padding(
